...
>> ***main proc*** in our program loads the variables specified in the ***.data*** segment of the program and calls the procedure ***DisplayChoice proc*** when ***check Module*** for ***restarting*** the program Turns out to be **True**.	
...
![EncryptingFun](Img/12.png)

![EncryptingFun](Img/13.png)
...
![DecryptingFun](Img/14.png)

![DecryptingFun](Img/15.png)
